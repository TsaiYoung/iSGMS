...
{
    public class UBHGrowthModel4:IUBHModels
    {
        /// <summary>
        ...
        public List<Tree> InvokeUBHModels(List<Tree> array, List<double> param, int age,double area)
        {
            ...
            {
                double CR = param[0] / Math.Pow(1 + param[1] * Math.Exp(-(param[2] + param[3] / age + param[4] * array.Count / 1000 + param[5] * DH + param[6] * array[i].DBH)), 1 / param[7]);
